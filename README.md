...
1. Nuskaito tavo nustatymus (`.env` ir `config.py`).
2. Pasiima akcijų kainas iš `yfinance`.
3. Palygina dabartinę kainą su tavo norima riba.
4. Jei sąlyga tenkinama – siunčia pranešimą į Telegram.
5. Išsaugo būseną (`state.json`), kad nesiųstų to paties perspėjimo kas ciklą.
6. Palaukia nustatytą laiką ir kartoja procesą.
